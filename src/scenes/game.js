...
export default function game(){ 
    ...
    const platforms = [
        k.add([k.sprite("platform"),k.pos(0,450),k.scale(4)],k.body({isStatic:true}),k.area()),
        k.add([k.sprite("platform"),k.pos(platfromWidth*4,450),k.scale(4)],k.body({isStatic:true}),k.area())
    ]
